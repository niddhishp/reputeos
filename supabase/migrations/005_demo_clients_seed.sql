...
-- Replace 'YOUR_USER_ID_HERE' with your actual auth.uid()
-- (find it in Supabase → Authentication → Users)
-- ============================================================

-- Step 1: Get your user ID (run this first to find your UUID)
-- SELECT id, email FROM auth.users ORDER BY created_at DESC LIMIT 5;

-- Step 2: Insert demo clients (replace the UUID below)
DO $$
DECLARE
  v_user_id UUID;
...
BEGIN
  -- Auto-detect: uses the most recently created user
  ...
  VALUES (
    ...
    'Technology / ESG',
    'https://linkedin.com/in/priya-sharma-cso',
    ARRAY['sustainability', 'ESG', 'climate tech', 'Infosys', 'net zero'],
    52, 78, 'active'
  )
  ON CONFLICT DO NOTHING;

  -- Discover run for Priya
  INSERT INTO discover_runs (
    client_id, status, progress, sources_total, sources_completed,
    total_mentions, sentiment_summary, frame_distribution, top_keywords,
    archetype_hints, summary, started_at, completed_at
  ) VALUES (
    c1_id, 'completed', 100, 62, 58,
    247,
    '{"positive": 68, "neutral": 22, "negative": 10, "average": 0.42}'::jsonb,
    '{"expert": 45, "founder": 12, "leader": 28, "family": 5, "crisis": 2, "other": 8}'::jsonb,
    ARRAY['sustainability', 'ESG', 'net zero', 'climate', 'Infosys', 'circular economy'],
    ARRAY['Sage', 'Caregiver', 'Ecosystem Builder'],
    'Priya Sharma has a strong positive reputation profile with 247 mentions across major Indian and global media. She is primarily framed as an expert voice on sustainability and ESG, with significant coverage in Economic Times and Business Standard. No crisis signals detected.',
  ...
  INSERT INTO positioning (
    ...
    c1_id, 'personal_and_business',
    'Sage', 'Ecosystem Builder',
    87, 74,
    ...
    ARRAY[
      'Media coverage is strong but concentrated in 3-4 outlets. Needs diversification to tier-1 international media (FT, Bloomberg).',
      ...
      'Social media presence is inconsistent — LinkedIn posts average 2x/month vs optimal 6x/month for this archetype.'
    ],
    ARRAY[
  ...
  VALUES (
    ...
    'Co-Founder & CEO',
    'Fintech / Payments',
    'https://linkedin.com/in/arjunmehta-razorpay',
    ARRAY['fintech', 'payments', 'Razorpay', 'startup', 'founder', 'UPI'],
    67, 85, 'active'
  )
  ON CONFLICT DO NOTHING;

  -- Discover run for Arjun
  INSERT INTO discover_runs (
    client_id, status, progress, sources_total, sources_completed,
    total_mentions, sentiment_summary, frame_distribution, top_keywords,
    archetype_hints, summary, started_at, completed_at
  ) VALUES (
    c2_id, 'completed', 100, 62, 61,
    891,
    '{"positive": 78, "neutral": 14, "negative": 8, "average": 0.61}'::jsonb,
    '{"expert": 22, "founder": 52, "leader": 18, "family": 3, "crisis": 1, "other": 4}'::jsonb,
    ARRAY['Razorpay', 'fintech', 'payments', 'UPI', 'startup', 'Series F', 'unicorn'],
  ...
  INSERT INTO positioning (
    ...
    ARRAY[
      'Crisis Moat score (2/10) is the most critical gap — zero crisis preparedness infrastructure despite high public profile.',
    ...
    ARRAY[
      ...
      'Transition narrative from "founder who built" to "leader who is building India''s financial OS" — lifts Elite Discourse.',
  ...
  VALUES (
    ...
    'Healthcare / MedTech',
    'https://linkedin.com/in/kavithanair-apollo',
    ARRAY['healthcare', 'Apollo Hospitals', 'medical', 'patient care', 'healthcare innovation'],
    38, 65, 'active'
  )
  ON CONFLICT DO NOTHING;

  -- Discover run for Kavitha
  INSERT INTO discover_runs (
    client_id, status, progress, sources_total, sources_completed,
    total_mentions, sentiment_summary, frame_distribution, top_keywords,
    archetype_hints, summary, started_at, completed_at
  ) VALUES (
    c3_id, 'completed', 100, 62, 44,
    89,
    '{"positive": 55, "neutral": 35, "negative": 10, "average": 0.28}'::jsonb,
    '{"expert": 38, "founder": 4, "leader": 20, "family": 18, "crisis": 6, "other": 14}'::jsonb,
    ARRAY['Apollo Hospitals', 'healthcare', 'oncology', 'patient outcomes', 'medical director'],
    ARRAY['Caregiver', 'Sage', 'Academic Practitioner'],
    'Kavitha Nair has a moderate but underdeveloped reputation profile with only 89 mentions. The family frame (18%) is unusually high for a medical professional, diluting her expert positioning. There is significant upside — her credentials exceed her digital footprint by a wide margin.',
  ...
  INSERT INTO positioning (
    ...
    'Dr. Kavitha Nair is India''s foremost authority on outcome-driven oncology — a Sage who bridges cutting-edge clinical evidence with the practical realities of delivering world-class care at scale in India.',
    ...
    ARRAY[
      'The family frame (18% of coverage) is coming from patient stories misattributing personal credit — needs reframing to institutional outcomes.',
      'Low mention volume (89) vs 20+ years of credentials indicates she has never invested in thought leadership — massive upside.',
      'Zero conference keynotes in last 24 months — this is the single biggest driver of her low Elite Discourse score.'
    ],
    ARRAY[
  ...
  RAISE NOTICE 'Demo clients created for user %', v_user_id;
END $$;
