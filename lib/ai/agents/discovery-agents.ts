...
Return JSON:
{"social_and_thought_leadership":{"overview_narrative":"honest paragraph on actual social presence from scan + profile data","visibility_tier":"High|Medium-High|Medium|Low|Minimal","linkedin":{"followers":"from profile/scan or 'not detected'","activity":"Active|Dormant|Absent|Unknown","positioning":"what LinkedIn presence shows if detected"},"twitter_x":{"followers":"from profile/scan or 'not detected'","activity":"Active|Dormant|Absent|Unknown","positioning":"what X presence shows if detected"},"wikipedia":{"exists":false,"quality":"None|Stub|Basic|Comprehensive"},"conference_participation":["only if found in scan — otherwise empty array"],"speaking_engagements":["only from scan results"],"op_eds":["only publications found in scan — include URLs if available"],"ai_discoverability":"High|Medium|Low|Minimal","ai_discoverability_narrative":"what AI tools would say based on available data","thought_leadership_gap":"most critical gap between their actual output and what their role demands"}}`,
    },
    {
      id: 'peer_comparison',
